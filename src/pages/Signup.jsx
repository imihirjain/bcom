...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://bcom-backend.onrender.com/api/auth/signup",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen flex font-indif items-center justify-center bg-slate-100">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label
              className="block text-slate-600 font-gara mb-2"
              htmlFor="name"
            >
              Name
            </label>
          ...
          <button
            type="submit"
            className="w-full bg-slate-700 font-gara text-white py-2 rounded-lg hover:bg-slate-600 transition-colors"
          >
            Sign Up
          </button>
        </form>
